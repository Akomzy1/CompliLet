...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      ...
      { text: "AI document fraud detection (Claude vision)", included: true },
      ...
      { text: "Konfir income verification (HMRC + payroll)", included: false },
  ...
  },
  {
    ...
    description: "Unlimited screenings + Konfir income verification + priority response.",
    features: [
      { text: "Everything in Pay-Per-Screen", included: true },
      { text: "Konfir income verification (HMRC, payroll, bank records)", included: true },
  ...
  },
  {
    ...
    interval: "monthly",
    intervalLabel: "per month",
    description: "Flat-rate management for landlords with up to 10 properties. Konfir-verified screening included.",
    features: [
      { text: "Up to 10 properties", included: true },
      { text: "Konfir-verified screening included", included: true },
      { text: "All Tenancy Manager features", included: true },
      { text: "Rent review agent (Section 13)", included: true },
      { text: "Priority WhatsApp support", included: true },
      { text: "Compliance reporting dashboard", included: true },
      { text: "Priority compliance support", included: true },
  ...
  },
  {
    ...
    interval: "per-property-monthly",
    intervalLabel: "per property / month",
    description: "Built for overseas landlords managing UK properties remotely. Konfir-verified screening included.",
    badge: "Overseas",
    features: [
      { text: "All Tenancy Manager features", included: true },
